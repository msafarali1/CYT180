# CYT180 — Lab 10: Email Spam Filtering 
**Weight:** 3% <br>
...
- Start from the downloaded notebook `Email-Spam-Detection.ipynb`. Make a personal copy of it and rename it to: `CYT180_Lab10_YourName.ipynb`. Work in your renamed copy for the entire lab.
