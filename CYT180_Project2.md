...
- All groups will present in Week 13 in the lab hours (this is the only presentation day)

---

## Blackboard Discussion Post (Project 2 Group Registration)

Each group must email the instructor:

- Names of group member(s)

This information allows the instructor to organize the presentation schedule.
The email must be sent before the end of Week 12.
